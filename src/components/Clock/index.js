    ...
    <div>
      <main>
        ...
        <div class="timer__buttons">
          <button class="timer__start-bttn bttn" type="button">
            START
          </button>
          <button class="timer__reset-bttn bttn" type="button">
            RESET
          </button>
        </div>
      </main>
      ...
      <footer>
        <p>
          Press spacebar or click on timer after a move to switch player's
          clock.
        </p>
      </footer>
